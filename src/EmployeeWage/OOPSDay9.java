...
public class OOPSDay9 {
    ...
    public static void main(String[] args) {
        ...
        OOPSDay9 CocaCola = new OOPSDay9();
        System.out.println(CocaCola.empWageCalculation(20,45,"CocaCola",45));

        OOPSDay9 Sting = new OOPSDay9();
        System.out.println(Sting.empWageCalculation(15,52,"Sting",150));
    }
